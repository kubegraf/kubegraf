import { c as createSignal, n as createEffect, o as onMount, E as onCleanup, t as template, i as insert, d as createComponent, S as Show, L as use, P as namespace } from './index-B8I71-mz.js';

var _tmpl$ = /* @__PURE__ */ template(`<div class="card p-6"><canvas class=w-full style="height:600px;background:rgba(10, 10, 20, 1);border-radius:8px">`), _tmpl$2 = /* @__PURE__ */ template(`<div class="card p-3"><div class=text-xs style=color:var(--text-secondary)><strong class=text-sm>Legend:</strong><div class="mt-1 flex flex-wrap gap-x-4 gap-y-1"><span><span style=color:#06b6d4>●</span> CPU (front/cyan)</span><span><span style=color:#8b5cf6>●</span> Memory (back/purple)</span><span>⚪ Latest data point</span><span>← Time flows left`), _tmpl$3 = /* @__PURE__ */ template(`<div class="p-6 space-y-6"><div class="flex items-center justify-between"><div><h1 class="text-2xl font-bold"style=color:var(--text-primary)>Resource Waterfall</h1><p class=text-sm style=color:var(--text-secondary)>3D ridge plot showing CPU and memory trends moving toward you over time`), _tmpl$4 = /* @__PURE__ */ template(`<div class="text-center py-12"><div class="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-white"></div><p class="mt-4 text-sm opacity-70">Loading metrics...`), _tmpl$5 = /* @__PURE__ */ template(`<div class="grid grid-cols-3 gap-4"><div class="card p-4"><div class=text-sm style=color:var(--text-secondary)>Current CPU</div><div class="text-3xl font-bold mt-2"style=color:#06b6d4>%</div></div><div class="card p-4"><div class=text-sm style=color:var(--text-secondary)>Current Memory</div><div class="text-3xl font-bold mt-2"style=color:#8b5cf6>%</div></div><div class="card p-4"><div class=text-sm style=color:var(--text-secondary)>Peak Values (60s)</div><div class="mt-2 space-y-1"><div class="text-lg font-bold"style=color:#06b6d4>CPU: <!>%</div><div class="text-lg font-bold"style=color:#8b5cf6>Mem: <!>%`);
const ResourceWaterfall = () => {
  ...
  const drawRidge = (ctx, history, baseY, vanishingX, vanishingY, width, type) => {
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        return [createComponent(Show, {
          ...
          children: (current) => (() => {
            var _el$15 = _tmpl$5(), _el$16 = _el$15.firstChild, _el$17 = _el$16.firstChild, _el$18 = _el$17.nextSibling, _el$19 = _el$18.firstChild, _el$20 = _el$16.nextSibling, _el$21 = _el$20.firstChild, _el$22 = _el$21.nextSibling, _el$23 = _el$22.firstChild, _el$24 = _el$20.nextSibling, _el$25 = _el$24.firstChild, _el$26 = _el$25.nextSibling, _el$27 = _el$26.firstChild, _el$28 = _el$27.firstChild, _el$30 = _el$28.nextSibling; _el$30.nextSibling; var _el$31 = _el$27.nextSibling, _el$32 = _el$31.firstChild, _el$34 = _el$32.nextSibling; _el$34.nextSibling;
            insert(_el$18, () => current().cpuUsage.toFixed(1), _el$19);
            insert(_el$22, () => current().memoryUsage.toFixed(1), _el$23);
            insert(_el$27, () => getMaxPeaks().cpu.toFixed(1), _el$30);
            insert(_el$31, () => getMaxPeaks().memory.toFixed(1), _el$34);
            return _el$15;
          })()
        }), (() => {
          ...
          var _el$8 = _tmpl$2(), _el$9 = _el$8.firstChild, _el$0 = _el$9.firstChild, _el$1 = _el$0.nextSibling, _el$10 = _el$1.firstChild; _el$10.firstChild; var _el$12 = _el$10.nextSibling; _el$12.firstChild;
          return _el$8;
        })()];
      }
    }), null);
...
export { ResourceWaterfall as default };
//# sourceMappingURL=ResourceWaterfall-Cnhb5Q4j.js.map
