...
// HandleUpdateCheck returns an http.HandlerFunc for GET /api/update/check
// Manual check for updates endpoint
// The getVersion function parameter allows the handler to access version
...
// HandleUpdateAutoCheck returns an http.HandlerFunc for GET /api/update/auto-check
