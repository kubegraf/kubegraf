...
export const CONTACT_EMAIL = 'mailto:contact@kubegraf.io';
export const SECURITY_URL = 'https://github.com/kubegraf/kubegraf/blob/main/SECURITY.md';
export const CONTRIBUTING_URL = 'https://github.com/kubegraf/kubegraf/blob/main/CONTRIBUTING.md';
