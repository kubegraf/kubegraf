...
export interface NavSection {
  title: string;
  items: NavItem[];
  conditional?: boolean; // If true, section is shown conditionally (e.g., ML section)
}

/**
 * Navigation sections configuration
 * Organized according to the new information architecture
 */
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    conditional: true, // Only shown when ML features are detected
  },
];
