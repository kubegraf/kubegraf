...
const IncidentDetailModal: Component<IncidentDetailModalProps> = (props) => {
  ...
  if (!props.isOpen || !props.incident) return null;
        ...
        <div style={{ 
          ...
          <Show when={props.incident.diagnosis}>
            <div style={{
              ...
              <Show when={props.incident.diagnosis?.probableCauses?.length > 0}>
                <div style={{ 'margin-bottom': '8px' }}>
                  <span style={{ 'font-size': '12px', color: 'var(--text-secondary)', 'font-weight': '600' }}>
                    Probable Causes:
                  </span>
                  <ul style={{ margin: '4px 0 0', 'padding-left': '20px' }}>
                    {props.incident.diagnosis?.probableCauses?.map((cause: string) => (
