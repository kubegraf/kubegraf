...
// This should be set via ldflags: -ldflags "-X github.com/kubegraf/kubegraf/cmd/cli.cliVersion=1.7.59"
// If not set, it defaults to the same version as main.version
// For consistency, use the same version as main: -ldflags "-X main.version=1.7.59 -X github.com/kubegraf/kubegraf/cmd/cli.cliVersion=1.7.59"
var cliVersion = "1.7.59" // Default matches version.go Version constant
